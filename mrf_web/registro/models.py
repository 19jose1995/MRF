...
class CargoProvincial(models.Model):
    ...
    orden = models.PositiveSmallIntegerField(choices=[
        ...
        (4, "COORDINADOR MEDICOS GENERALES Y ESPECIALISTAS"),
        (5, "COORDINADOR (A) DE ENFERMERIA"),
        (6, "COORDINADOR (A) DE SALUD MENTAL"),
        (7, "COORDINADOR (A) DE ODONTOLOGIA"),
        (8, "COORDINADOR (A) DE TECNICOS DEL SECTOR SALUD"),
        (9, "COORDINADOR (A) DE BIOANALISIS"),
        (10, "COORDINADOR DE IGLESIAS Y ORGANIZACIONES SIN FINES DE LUCRO"),
